...
Ta có bảng biến thiên với giá trị $x=\frac{r}{N}$ từ nửa khoảng $(0,1]$
![](bang_bien_thien.png)
<figcaption>Bảng biến thiên</figcaption>

**Đồ thị hàm số của $f(x)$**

![](do_thi_ham_so.png)
<figcaption>Đồ thị hàm số</figcaption>


## Kết luận

Vậy với bài toán hẹn hò với $N$ ứng viên và $r$ ứng viên bị bỏ qua để hình thành sựa lựa chọn, ta có hai công thức về xác suất lựa chọn
ứng viên giỏi nhất
